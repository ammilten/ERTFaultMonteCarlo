...
#    MCfolder = '/home/ammilten/Programs/ERTFaultMonteCarlo/data/MC/'
    ...
    shdep = [0.3, 5] #uniform
    rho_sh = [40, 30, .8] #lognormal
    fpthx = [0.25, 3] #uniform
    rho_fp = [40, 30, .8] #lognormal
    ...
    if imp:
        ...
        MC = MonteCarlo.MonteCarlo(dep, xtra, Q, dip, H, xpos, rho_fault, rho_back, shdep, rho_sh, fpthx, rho_fp, N, MCfolder, overwrite, parallel, nproc, showDists)
