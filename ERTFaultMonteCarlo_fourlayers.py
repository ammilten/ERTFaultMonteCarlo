import MonteCarlo_fourlayers as MonteCarlo
...
#    MCfolder = '/home/ammilten/Programs/ERTFaultMonteCarlo/data/MC/'
    ...
    thx_soil       = [0.3, 0.7] #uniform
    thx_subsoil    = [0.3, 0.7] #uniform
    thx_weathered  = [1, 4] #uniform
    rho_soil       = [40, 30, .8] #lognormal
    rho_subsoil    = [40, 30, .8] #lognormal
    rho_weathered  = [40, 30, .8] #lognormal
    rho_bedrock    = [30, 50, .8] #lognormal
    ...
    if imp:
        ...
        MC = MonteCarlo.MonteCarlo(dep, xtra, Q, thx_soil, thx_subsoil, thx_weathered, rho_soil, rho_subsoil, rho_weathered, rho_bedrock, N, MCfolder, overwrite, parallel, nproc, showDists)
